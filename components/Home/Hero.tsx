    ...
    <div className='w-full h-[calc(100vh-12vh)] flex justify-center flex-col'>
      ...
      <div>
        <h1 className='text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-black font-bold uppercase'>
          mega sale <span className='text-rose-600'>Special</span> Offer up to <span className='text-orange-500'>50%</span> Off
        </h1>
        <p className='text-sm md:text-base lg:text-lg text-black text-opacity-70 mt-4'>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Ipsa voluptas officia architecto pariatur aliquid eos ipsam numquam, mollitia molestiae dolorem ab fuga perspiciatis itaque quis quae vel culpa iste asperiores!</p>
